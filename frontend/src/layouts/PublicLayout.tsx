      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8 text-sm font-medium tracking-wide">
            ...
            <a href="/venta" className="hover:text-blue-400 transition-colors">COMPRAR</a>
            <a href="/alquiler" className="hover:text-blue-400 transition-colors">ALQUILAR</a>
          </div>

          {/* Iconos Derecha */}
          <div className="flex items-center space-x-6">
            <button className="hover:text-blue-400"><MessageCircle size={20} /></button>
            <button className="hover:text-blue-400"><User size={20} /></button>
          </div>
        </div>
      </nav>
