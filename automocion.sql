...
--
-- Servidor: db:3306
-- Tiempo de generación: 25-02-2026 a las 16:01:30
...
--
-- Estructura de tabla para la tabla `body_type`
--
...
--
-- Volcado de datos para la tabla `body_type`
--
...
CREATE TABLE `color` (
  `id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `hex_code` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `conversation` (`id`, `contact_name`, `contact_email`, `contact_phone`, `created_at`, `updated_at`, `status`, `vehicle_id`, `user_id`, `reservation_id`) VALUES
...
--
-- Estructura de tabla para la tabla `enviromental_badge`
--
...
--
-- Volcado de datos para la tabla `enviromental_badge`
--

INSERT INTO `enviromental_badge` (`id`, `name`, `image`) VALUES
(40, 'B', NULL),
(41, 'C', NULL),
(42, 'ECO', NULL),
(43, '0 Emisiones', NULL);
...
INSERT INTO `favorite` (`id`, `created_at`, `user_id`, `vehicle_id`) VALUES
...
INSERT INTO `message` (`id`, `content`, `created_at`, `is_admin`, `conversation_id`) VALUES
...
INSERT INTO `reservation` (`id`, `start_date`, `end_date`, `status`, `total_price`, `vehicle_id`, `user_id`) VALUES
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `name`, `surname`, `phone`, `province_id`) VALUES
(206, 'admin@concesionario.com', '[\"ROLE_ADMIN\"]', '$2y$13$1Z.Nhcmg18DSwFEeMPM4WO3T48Bn9SFX9FF/7S8cCiy7ksrPmYyQW', 'Admin', 'Gerente', '', NULL),
...
INSERT INTO `vehicle` (`id`, `price`, `year`, `kilometres`, `power`, `displacement`, `doors`, `owners`, `description`, `status`, `created_at`, `updated_at`, `brand_id`, `model_id`, `fuel_type_id`, `transmission_id`, `body_type_id`, `enviromental_badge_id`, `color_id`, `visible`, `province_id`, `type`, `daily_price`) VALUES
(357, '31833', 2018, 133896, 290, 2000, 5, 2, 'Odit deserunt facere ut delectus consequuntur. Et commodi odit quis explicabo voluptas aut.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 190, 40, 20, 47, 41, 55, 1, 115, 'SALE', NULL),
(358, NULL, 2023, 78467, 169, 3000, 3, 2, 'Consequatur natus ut qui rerum. Quis quis voluptates magni placeat.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 53, 185, 41, 19, 47, 40, 57, 1, 111, 'RENT', 181.00),
(359, '62698', 2021, 67032, 137, 3000, 3, 3, 'Est earum sit perferendis maiores. Eligendi quae et nostrum molestias architecto voluptatem quo. Ut modi magni qui nisi non eum et dicta.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 179, 40, 19, 46, 40, 53, 1, 109, 'SALE', NULL),
(360, '25581', 2024, 145044, 115, 3000, 3, 2, 'Et sit ut et accusamus. Non quia facilis voluptate ut adipisci quisquam ratione sequi.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 187, 40, 19, 48, 41, 55, 1, 109, 'SALE', NULL),
(361, '65507', 2021, 47932, 109, 1500, 3, 3, 'Quos et ut ullam repudiandae iure quis. Accusantium quibusdam animi enim voluptatem ad facere enim.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 174, 41, 20, 46, 42, 57, 1, 115, 'SALE', NULL),
(362, '61153', 2018, 50182, 216, 1500, 3, 1, 'Officiis tenetur fuga possimus. Harum voluptatibus occaecati qui natus.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 189, 40, 19, 45, 43, 57, 1, 113, 'SALE', NULL),
(363, '15365', 2024, 15691, 191, 1500, 5, 1, 'Odio sapiente blanditiis temporibus laudantium voluptas debitis totam. A autem temporibus excepturi dolorem.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 180, 39, 19, 45, 41, 56, 1, 112, 'SALE', NULL),
(364, '55343', 2024, 58742, 399, 2000, 5, 3, 'Aut animi cumque molestiae nihil omnis. Nam laborum odio qui labore voluptate ut iste.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 180, 42, 20, 44, 40, 57, 1, 113, 'SALE', NULL),
(365, '65966', 2020, 72355, 130, 3000, 3, 3, 'Harum est repudiandae incidunt iste tempora maxime est. Adipisci ex autem aut autem.', 'SOLD', '2026-01-23 12:42:30', NULL, 50, 172, 39, 20, 48, 40, 53, 1, 109, 'SALE', NULL),
(366, '50256', 2023, 56442, 126, 1500, 3, 2, 'Esse nostrum commodi delectus tenetur hic magni repellendus in. Molestiae non magni voluptas quod est dolor.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 175, 41, 19, 46, 43, 53, 1, 112, 'SALE', NULL),
(367, NULL, 2019, 101420, 241, 3000, 5, 2, 'Est est ad minima molestiae. Tempore beatae reiciendis debitis cumque enim nobis. Libero illum quisquam totam accusantium ea maiores.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 172, 41, 20, 47, 43, 57, 1, 115, 'RENT', 109.00),
(368, NULL, 2020, 122622, 165, 1500, 5, 1, 'Consequuntur accusamus quae nisi est assumenda doloribus incidunt. Aut alias accusamus cupiditate rerum cum incidunt.', 'SOLD', '2026-01-23 12:42:30', NULL, 55, 190, 39, 20, 46, 43, 52, 1, 109, 'RENT', 191.00),
(369, NULL, 2019, 120783, 242, 1500, 3, 2, 'Numquam qui minima veniam natus. Delectus quia commodi et quia sit maxime ex. Nulla reiciendis quia iste quisquam occaecati nostrum qui.', 'SOLD', '2026-01-23 12:42:30', NULL, 51, 178, 42, 20, 47, 42, 56, 1, 115, 'RENT', 127.00),
(370, '57320', 2024, 52575, 214, 2000, 5, 2, 'Vel rerum magni impedit commodi mollitia similique alias. Est maiores itaque cupiditate ut voluptatem possimus commodi.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 176, 40, 19, 47, 40, 56, 1, 114, 'SALE', NULL),
(371, '68839', 2024, 85266, 287, 1500, 3, 1, 'Qui saepe perspiciatis sed occaecati. Accusantium deserunt ea cumque.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 186, 39, 20, 45, 41, 55, 1, 109, 'SALE', NULL),
(372, '41340', 2023, 62095, 183, 1500, 5, 2, 'Culpa facere maiores laborum praesentium hic debitis sint. Itaque quisquam fuga nihil repellat.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 179, 41, 19, 44, 42, 57, 1, 113, 'SALE', NULL),
(373, NULL, 2021, 11207, 235, 2000, 3, 3, 'Qui delectus doloremque iure expedita modi. Unde facilis libero dignissimos molestias odit. Consequuntur ut corporis unde quos voluptas repellat iste.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 178, 40, 19, 44, 41, 54, 1, 114, 'RENT', 174.00),
(374, '64481', 2024, 22828, 239, 2000, 3, 1, 'Rerum laborum aut ea ab voluptate. Aut qui nisi commodi deleniti.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 173, 41, 20, 47, 42, 56, 1, 112, 'SALE', NULL),
(375, NULL, 2021, 128513, 123, 1500, 3, 3, 'Accusamus id voluptatem sit voluptate maiores. Assumenda inventore id labore illo. Non eos quo alias quas.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 177, 39, 20, 45, 42, 52, 1, 113, 'RENT', 76.00),
(376, '54717', 2023, 147643, 329, 2000, 3, 1, 'Ea commodi commodi aperiam odio nisi eos in. Accusamus hic laborum et magni debitis et rerum.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 53, 185, 40, 19, 48, 43, 56, 1, 115, 'SALE', NULL),
(377, NULL, 2022, 23524, 243, 2000, 3, 3, 'Facilis aperiam nesciunt unde vero optio. Sit necessitatibus nihil aut atque eum.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 179, 40, 19, 47, 42, 53, 1, 115, 'RENT', 94.00),
(378, '70061', 2022, 92695, 147, 3000, 5, 2, 'Aperiam ea corrupti earum veritatis modi corrupti. Est sunt aspernatur quaerat vel at mollitia expedita. Consectetur ut consequuntur vitae quia non modi ab.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 189, 39, 20, 44, 42, 55, 1, 110, 'SALE', NULL),
(379, NULL, 2018, 123086, 273, 1500, 3, 2, 'Quis unde eum sit. Consectetur ad amet iure a rerum.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 178, 40, 19, 45, 42, 57, 1, 115, 'RENT', 125.00),
(380, '74805', 2021, 16755, 195, 1500, 3, 2, 'Rerum consequatur maxime magni est. Aspernatur laborum dolores ut est.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 53, 183, 40, 20, 45, 40, 56, 1, 111, 'SALE', NULL),
(381, '79341', 2022, 21817, 205, 1500, 3, 3, 'Voluptas quisquam totam dolore debitis quasi qui. Aliquid reprehenderit corrupti nihil est. Iste a est unde aut qui at harum.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 186, 42, 20, 44, 42, 53, 1, 115, 'SALE', NULL),
(382, '60498', 2019, 76070, 133, 2000, 5, 3, 'Omnis non recusandae quae consequuntur. Incidunt sit fugit et necessitatibus. Quidem esse quasi rerum voluptatem magni porro.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 186, 42, 20, 46, 40, 55, 1, 115, 'SALE', NULL),
(383, '73671', 2023, 68500, 222, 3000, 5, 1, 'Quam consequuntur impedit aperiam minus in. Molestias consectetur esse eos enim ex veritatis ducimus. Aut veniam dicta debitis vitae minus et accusantium eligendi.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 174, 39, 19, 44, 43, 55, 1, 109, 'SALE', NULL),
(384, NULL, 2018, 93475, 118, 1500, 5, 1, 'Dolore perspiciatis molestias error deleniti in sequi. Aliquam molestiae dolorem quia dolore dolor natus dolor.', 'SOLD', '2026-01-23 12:42:30', NULL, 52, 180, 41, 19, 47, 41, 55, 1, 109, 'RENT', 115.00),
(385, '36181', 2022, 58526, 327, 3000, 3, 1, 'Quis omnis aperiam sit quia reiciendis qui. In quia et nam ea dolore.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 176, 41, 19, 44, 43, 56, 1, 115, 'SALE', NULL),
(386, NULL, 2020, 29624, 198, 1500, 3, 1, 'Doloribus sed maiores ullam dolores nemo dolorem. Fuga neque consectetur sapiente pariatur sed. Eos velit consequuntur est qui sed.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 188, 40, 20, 46, 43, 53, 1, 109, 'RENT', 171.00),
(387, '55268', 2019, 46970, 216, 1500, 3, 1, 'Rem sequi fuga alias ex vel ut dolores. Qui quaerat dolorem sed aliquid maxime hic.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 175, 42, 20, 45, 42, 55, 1, 114, 'SALE', NULL),
(388, NULL, 2022, 84909, 330, 3000, 3, 2, 'Aliquam accusantium sunt dicta consequatur magnam recusandae natus. Quaerat perferendis est esse qui dolore cupiditate.', 'SOLD', '2026-01-23 12:42:30', NULL, 50, 174, 39, 19, 48, 43, 56, 1, 112, 'RENT', 126.00),
(389, NULL, 2020, 146517, 316, 3000, 3, 3, 'Ipsam animi distinctio necessitatibus corporis ratione animi. Commodi itaque tempora ea non occaecati et sequi.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 191, 40, 20, 45, 42, 52, 1, 109, 'RENT', 77.00),
(390, '33786', 2020, 67816, 310, 2000, 5, 1, 'Dolorem repellendus distinctio sint explicabo et. Facilis aspernatur in voluptates eaque autem quo. Excepturi doloribus voluptate quod esse dolor tempore.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 189, 40, 19, 46, 40, 52, 1, 113, 'SALE', NULL),
(391, NULL, 2021, 105373, 233, 3000, 3, 3, 'Ullam optio sapiente saepe vel. Hic incidunt saepe voluptatem ea id ipsam ut.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 172, 42, 19, 46, 42, 54, 1, 115, 'RENT', 99.00),
...
(393, NULL, 2019, 15635, 297, 3000, 5, 2, 'Occaecati porro explicabo dicta et ab. Qui mollitia qui corrupti quia eius quasi.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 189, 41, 20, 46, 40, 52, 1, 110, 'RENT', 77.00),
(394, '34700', 2024, 39008, 311, 2000, 5, 2, 'Sit sed repudiandae ut voluptatum impedit et. Nihil maiores aut at est ullam.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 172, 42, 20, 45, 41, 57, 1, 113, 'SALE', NULL),
(395, '71507', 2023, 86298, 286, 2000, 3, 3, 'Rerum et facilis et labore cumque fugit saepe alias. Placeat eveniet expedita asperiores esse cupiditate. Sunt nihil similique ut et et consequuntur.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 188, 39, 19, 45, 42, 56, 1, 111, 'SALE', NULL),
(396, NULL, 2019, 149960, 120, 2000, 3, 3, 'Magni voluptatem consequuntur omnis ipsa. Voluptas quos atque accusantium cupiditate sint voluptatem excepturi porro. Rerum ut exercitationem harum modi.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 174, 40, 19, 44, 40, 55, 1, 109, 'RENT', 172.00),
(397, '37650', 2021, 62923, 219, 2000, 5, 2, 'Ipsum optio voluptates ex eos explicabo rem dolores. Nostrum enim voluptatem porro molestiae cupiditate quos sint.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 180, 41, 20, 48, 42, 54, 1, 113, 'SALE', NULL),
(398, NULL, 2024, 77944, 126, 2000, 5, 2, 'Sed ut eos et animi earum ut. Voluptatem quas molestiae velit impedit eum nisi. Corporis rem aut minima et cumque veritatis.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 174, 39, 20, 45, 40, 57, 1, 110, 'RENT', 159.00),
(399, NULL, 2021, 80129, 251, 1500, 3, 2, 'Nemo accusantium omnis maxime magnam assumenda ex quis. Est molestiae et expedita eos qui possimus laboriosam. Et sapiente voluptatem debitis.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 189, 41, 19, 45, 41, 54, 1, 112, 'RENT', 74.00),
(400, '33259', 2023, 79908, 342, 1500, 5, 2, 'Sint occaecati vero eaque veritatis velit placeat veniam. Distinctio ut asperiores modi vero. Cumque commodi dicta provident omnis inventore sit.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 174, 40, 19, 48, 43, 54, 1, 112, 'SALE', NULL),
(401, NULL, 2024, 100234, 180, 2000, 5, 3, 'Enim nobis quasi doloribus ipsum tempora aspernatur. Cupiditate veritatis sint sunt ut. Tempore aut enim suscipit sit consectetur.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 173, 40, 19, 47, 40, 55, 1, 110, 'RENT', 61.00),
(402, NULL, 2019, 57828, 267, 3000, 5, 2, 'Non facere officiis quis est hic voluptas excepturi. Ab optio eius sequi omnis est.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 176, 41, 19, 44, 42, 54, 1, 111, 'RENT', 78.00),
(403, NULL, 2019, 115698, 221, 1500, 5, 3, 'Dolorem ut sit dolorum voluptas est ut. Deserunt ab iste placeat eligendi et harum.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 174, 42, 19, 47, 43, 57, 1, 110, 'RENT', 130.00),
(404, '44285', 2023, 104485, 158, 2000, 3, 2, 'Corrupti sint nulla sit reprehenderit. Rerum delectus aperiam nemo adipisci dolores.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 50, 171, 39, 20, 47, 42, 52, 1, 112, 'SALE', NULL),
(405, '42290', 2018, 86969, 294, 2000, 5, 3, 'Ex non officiis ab perspiciatis ab et. Eaque explicabo est similique eos praesentium est quia. Voluptas incidunt voluptas quo.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 51, 178, 41, 20, 47, 43, 53, 1, 113, 'SALE', NULL),
(406, '36662', 2018, 11452, 394, 1500, 5, 3, 'Quo saepe officiis rem totam eaque. Est sit voluptatem quis rerum.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 188, 39, 19, 44, 41, 54, 1, 113, 'SALE', NULL),
(407, '42685', 2022, 56324, 357, 1500, 3, 1, 'Hic voluptatem voluptatum sit. Consequuntur laborum consequatur inventore nemo tempore repellat inventore ipsa. Provident non sed fugit totam.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 181, 39, 20, 45, 43, 57, 1, 109, 'SALE', NULL),
(408, NULL, 2022, 119919, 220, 3000, 5, 2, 'Sit qui minus aspernatur doloremque et rem alias. Placeat repellat facilis est odio aut vero ipsam.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 55, 189, 40, 19, 46, 41, 53, 1, 114, 'RENT', 73.00),
(409, NULL, 2024, 4464, 257, 2000, 5, 1, 'Omnis harum iusto neque alias soluta. Quas voluptatem sunt nihil impedit rem itaque. Eius ipsum rerum aut facilis autem illum quis dolores.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 53, 184, 39, 19, 46, 40, 55, 1, 109, 'RENT', 87.00),
(410, '45101', 2024, 81705, 395, 3000, 5, 3, 'Aut exercitationem nihil dolorum facere. Ullam qui et velit culpa voluptatem culpa.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 179, 39, 19, 47, 43, 57, 1, 114, 'SALE', NULL),
(411, NULL, 2020, 84600, 396, 3000, 5, 2, 'Similique sint consequatur et eos. Itaque nesciunt omnis dolor. Fuga quia ducimus modi quo sint error dolores.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 53, 184, 42, 20, 47, 43, 54, 1, 113, 'RENT', 105.00),
(412, '69171', 2021, 144725, 189, 1500, 5, 3, 'Voluptatem sunt ad qui velit fuga omnis. Et magnam odit autem illum aliquam quis aut. Explicabo consectetur odio nostrum aut id.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 52, 180, 42, 20, 46, 43, 57, 1, 114, 'SALE', NULL),
(414, '19800', 2019, 142864, 116, 2000, 5, 1, '¡El compacto por excelencia en un estado impecable!\n\nSe vende Volkswagen Golf en su versión Sport, una de las más equilibradas de la gama. Este motor 1.5 TSI de 150 CV destaca por su suavidad de marcha y un consumo muy contenido gracias al sistema de gestión activa de cilindros (ACT).\n\nEquipamiento Destacado:\n\nDigital Cockpit: Cuadro de instrumentos totalmente digital y personalizable.\n\nApp-Connect: Apple CarPlay y Android Auto para que lleves tu música y mapas siempre contigo.\n\nFaros LED: Máxima visibilidad nocturna y estética moderna.\n\nControl de crucero adaptativo (ACC): Conducción más segura y relajada en autopista.\n\nSensores de aparcamiento: Delanteros y traseros con ayuda visual en pantalla.\n\nEstado del coche:\nVehículo procedente de único propietario, siempre guardado en garaje y con libro de revisiones al día en servicio oficial. Pintura original sin arañazos y neumáticos al 80%.\n\nSe entrega revisado, con transferencia incluida y 12 meses de garantía premium.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 53, 183, 39, 19, 46, 41, 53, 1, 112, 'SALE', NULL),
(415, '53674', 2023, 96847, 251, 3000, 5, 3, 'Placeat quibusdam est itaque facilis cum. Error veniam maxime ratione. Et dolorem recusandae voluptate voluptatem quisquam.', 'SOLD', '2026-01-23 12:42:30', NULL, 52, 180, 40, 20, 47, 43, 57, 1, 114, 'SALE', NULL),
(416, '66028', 2018, 36762, 262, 2000, 3, 2, 'Provident voluptate ut velit ipsam. Ut dolores rerum quaerat provident aliquam voluptatibus. Excepturi quia sed et qui.', 'AVAILABLE', '2026-01-23 12:42:30', NULL, 54, 186, 39, 20, 45, 40, 53, 1, 109, 'SALE', NULL),
(418, '14000', 2015, 140000, 150, 2000, 3, 3, 'Un Audi A4 super guapo de gitanillo asi del almanjayar', 'AVAILABLE', '2026-01-24 13:16:44', NULL, 51, 176, 40, 19, 45, 42, 53, 1, 114, 'SALE', NULL),
(419, '43000', 2026, 487263, 150, 234234, 5, 1, 'asdadadasd', 'RESERVED', '2026-01-24 13:20:37', NULL, 51, 175, 42, 19, 45, 41, 53, 1, 112, 'SALE', NULL),
(420, NULL, 2026, 2342343, 233, 2333, 5, 1, 'dfsfsdfsfsdf', 'AVAILABLE', '2026-01-24 13:31:10', NULL, 52, 179, 41, 19, 44, 41, 54, 1, 111, 'RENT', 143.00),
...
--
-- Volcado de datos para la tabla `vehicle_image`
--

INSERT INTO `vehicle_image` (`id`, `filename`, `is_main`, `vehicle_id`) VALUES
(3, 'https://placehold.co/800x600?text=Ford+Fiesta+1', 1, 357),
(4, 'https://placehold.co/800x600?text=Ford+Fiesta+2', 0, 357),
(5, 'https://placehold.co/800x600?text=Ford+Fiesta+3', 0, 357),
(6, 'https://placehold.co/800x600?text=Volkswagen+Tiguan+1', 1, 358),
(7, 'https://placehold.co/800x600?text=Mercedes+Clase+A+1', 1, 359),
(8, 'https://placehold.co/800x600?text=Toyota+Yaris+1', 1, 360),
(9, 'https://placehold.co/800x600?text=BMW+M4+1', 1, 361),
(10, 'https://placehold.co/800x600?text=BMW+M4+2', 0, 361),
...
(115, 'https://placehold.co/800x600?text=Toyota+RAV4+1', 1, 406),
...
(122, 'https://placehold.co/800x600?text=Volkswagen+Polo+1', 1, 409),
(123, 'https://placehold.co/800x600?text=Volkswagen+Polo+2', 0, 409),
(124, 'https://placehold.co/800x600?text=Volkswagen+Polo+3', 0, 409),
...
(139, 'https://placehold.co/800x600?text=Mercedes+Clase+C+1', 1, 415),
(140, 'https://placehold.co/800x600?text=Toyota+Corolla+1', 1, 416),
(141, 'https://placehold.co/800x600?text=Toyota+Corolla+2', 0, 416),
(142, '6974b098f40f1.png', 0, NULL),
(143, '6974b09937ed1.png', 1, NULL),
(144, '6974b0dd2598f.png', 1, NULL),
(145, '6974b0dd3fcd9.jpg', 0, NULL),
(146, '6974b1cfab72f.png', 1, NULL),
(147, '6974b1cfc9b51.jpg', 0, NULL),
(148, '6974b24bec76f.png', 1, NULL),
(149, '6974b24c10aee.png', 0, NULL),
(150, '6974b2cfca25f.png', 1, NULL),
(151, '6974b2cfdc600.png', 0, NULL),
(152, '6974b3e678d86.png', 0, NULL),
(153, '6974b3e695424.png', 1, NULL),
(154, '6974b4ae87087.png', 0, NULL),
(155, '6974b4aea3825.png', 1, NULL),
(156, '6974b5c9d7da5.png', 0, NULL),
(157, '6974b5ca29882.png', 1, NULL),
(158, '6974b61543716.jpg', 1, NULL),
(159, '6974b61564957.jpg', 0, NULL),
(162, '6974b82ca1062.jpg', 1, 418),
(163, '6974b82cc2b11.jpg', 0, 418),
(164, '6974b8a88be99.jpg', 1, NULL),
(165, '6974b8a8a98f3.jpg', 0, NULL),
(166, '6974b8f75596d.jpg', 1, NULL),
(167, '6974b8f772c7c.jpg', 0, NULL),
(168, '6974b915812e4.jpg', 0, 419),
(169, '6974b915a2aa1.jpg', 1, 419),
(170, '6974bb8db7bbd.jpg', 1, 420),
(171, '6974bb8dd7842.jpg', 0, 420),
(172, '6974bcc5280a0.jpg', 1, 421),
(173, '6974bcc546774.jpg', 0, 421),
(174, '6978abde5eacc.jpg', 1, 422),
(175, '6978abdeb7476.jpg', 0, 422),
(176, '697a6d4506fc5.jpg', 0, 423),
(177, '699c9e42159ec.jpg', 0, 414),
(178, '699c9e424e280.jpg', 0, 414),
(179, '699c9e4269fe8.jpg', 0, 414),
(180, '699c9f24aa3a1.jpg', 0, 425),
(181, '699c9f24c8c6d.jpg', 0, 425);
...
ALTER TABLE `conversation`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_8A8E26E9B83297E7` (`reservation_id`),
  ADD KEY `IDX_8A8E26E9545317D1` (`vehicle_id`),
...
--
-- Indices de la tabla `enviromental_badge`
--
ALTER TABLE `enviromental_badge`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `favorite`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_FAVORITE_USER_VEHICLE` (`user_id`,`vehicle_id`),
  ADD KEY `IDX_68C58ED9A76ED395` (`user_id`),
  ADD KEY `IDX_68C58ED9545317D1` (`vehicle_id`);
...
ALTER TABLE `reservation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_42C84955545317D1` (`vehicle_id`),
...
ALTER TABLE `user`
  ...
  ADD KEY `IDX_8D93D649E946114A` (`province_id`);
...
ALTER TABLE `vehicle`
  ...
  ADD KEY `IDX_1B80E4866A70FE35` (`fuel_type_id`),
  ADD KEY `IDX_1B80E48678D28519` (`transmission_id`),
  ADD KEY `IDX_1B80E4862CBA3505` (`body_type_id`),
  ADD KEY `IDX_1B80E48664F6DB96` (`enviromental_badge_id`),
  ADD KEY `IDX_1B80E4867ADA1FB5` (`color_id`),
  ADD KEY `IDX_1B80E486E946114A` (`province_id`);

--
-- Indices de la tabla `vehicle_image`
--
ALTER TABLE `vehicle_image`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_A79284B3545317D1` (`vehicle_id`);
...
--
-- AUTO_INCREMENT de la tabla `body_type`
--
ALTER TABLE `body_type`
...
--
-- AUTO_INCREMENT de la tabla `enviromental_badge`
--
ALTER TABLE `enviromental_badge`
...
--
-- AUTO_INCREMENT de la tabla `vehicle_image`
--
ALTER TABLE `vehicle_image`
...
--
ALTER TABLE `conversation`
  ADD CONSTRAINT `FK_8A8E26E9545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
  ADD CONSTRAINT `FK_8A8E26E9A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_8A8E26E9B83297E7` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`);

--
-- Filtros para la tabla `favorite`
--
ALTER TABLE `favorite`
  ADD CONSTRAINT `FK_68C58ED9545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
...
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `FK_42C84955545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_8D93D649E946114A` FOREIGN KEY (`province_id`) REFERENCES `province` (`id`);

--
-- Filtros para la tabla `vehicle`
--
ALTER TABLE `vehicle`
  ADD CONSTRAINT `FK_1B80E4862CBA3505` FOREIGN KEY (`body_type_id`) REFERENCES `body_type` (`id`),
  ADD CONSTRAINT `FK_1B80E48644F5D008` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`id`),
  ADD CONSTRAINT `FK_1B80E48664F6DB96` FOREIGN KEY (`enviromental_badge_id`) REFERENCES `enviromental_badge` (`id`),
  ADD CONSTRAINT `FK_1B80E4866A70FE35` FOREIGN KEY (`fuel_type_id`) REFERENCES `fuel` (`id`),
  ...
  ADD CONSTRAINT `FK_1B80E4867ADA1FB5` FOREIGN KEY (`color_id`) REFERENCES `color` (`id`),
  ADD CONSTRAINT `FK_1B80E486E946114A` FOREIGN KEY (`province_id`) REFERENCES `province` (`id`);

--
-- Filtros para la tabla `vehicle_image`
--
ALTER TABLE `vehicle_image`
  ADD CONSTRAINT `FK_A79284B3545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`);
COMMIT;
